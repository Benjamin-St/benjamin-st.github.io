...
MultiPage = React.createClass({displayName: "MultiPage",
  getInitialState: function() {
    var children;
  ...
  render: function() {
    var Component, child, children, i, len, self;
    children = this.props.children;
...
module.exports = function (locals) {
  var tags = [];
  tags.push(React.createElement("div", {
    title: "Health Insurance Exchange API",
    subtitle: "An API for getting information about insurance providers"
  }, React.createElement("p", {}, 'For a final project in the class "Health Policy and the Open Data Revolution," I built an API which provided clients information about health insurance options. The data came from the Health Insurance Exchange open data set, and the API exposed an endpoint for listing insurance providers given a zipcode and getting more details about a provider. This API was part of a larger project which helped users find the insurance provider for them.'), React.createElement("p", {}, "Through this project, I learned about setting up a Ruby on Rails project, seeding a database using this framework, configuring a postgres database, and deploying a project to Heroku.")));
  if (tags.length === 1 && !Array.isArray(tags[0])) {
    return tags.pop();
  }
  tags.unshift("div", null);
...
module.exports = function (locals) {
  ...
  tags.push(React.createElement("div", {
    ...
    subtitle: ""
  }, React.createElement("p", {}, "I love making web apps. I especially love working with single page apps because of the problem of managing that complexity interests me. Most of my experience is with front end development, but I know how to use several MVC backend frameworks."), React.createElement("p", {}, "Here's a list of things I have most experience with."), React.createElement("ul", {}, React.createElement("li", {}, "JavaScript / CoffeeScript", React.createElement("ul", {}, React.createElement("li", {}, "Front end frameworks such as jQuery, Backbone, and React.js"), React.createElement("li", {}, "Back end frameworks such as Express and Sails.js"), React.createElement("li", {}, "Async.js and Promises"), React.createElement("li", {}, "Testing using Mocha and Chai assertations"))), React.createElement("li", {}, "HTML / CSS / Jade / Stylus", React.createElement("ul", {}, React.createElement("li", {}, "Build tools such as gulp and browserify"))), React.createElement("li", {}, "C#, ASP.NET MVC, Entity Framework"))));
  if (tags.length === 1 && !Array.isArray(tags[0])) {
    return tags.pop();
  }
  tags.unshift("div", null);
...
module.exports = function (locals) {
  ...
  tags.push(React.createElement("div", {
    title: "Yoop App",
    subtitle: "Discover and name your own price on shoes"
  }, React.createElement("p", {}, "During my internship at H.H. Brown, my team built an iOS app for discovering and naming your own price on shoes. This was my first experience working with mobile apps ever, but after two and a half months of learning and hard work, we managed to complete most of a functional version 1."), React.createElement("p", {}, "The idea is you take a personality quiz, and you get 12 new shoes suggested to you each day. You then like or dislike those shoes in your queue. You can then bid on shoes that you liked, and you'll later find out if you won the bid. If you won, you can buy the shoes right from the app."), React.createElement("p", {}, "I ended up learning about so many technologies through this experience. On the iOS specific side, I learned much about object oriented programming, dealing with asynchronous APIs, working with ORMs, and using git and GitHub when working with a team. I also learned about using Parse SDK as a backend, using Facebook OAuth and Facebook's Graph API to get a user's email and profile picture, tracking UI events with Google Analytics, and making payments with Stripe's API."), React.createElement("p", {}, React.createElement("a", {
    href: "./pics/yoopvideo.mov"
  }, "Here's a long 3 minute (64mb) video of me using the app."))));
  if (tags.length === 1 && !Array.isArray(tags[0])) {
    return tags.pop();
  }
  tags.unshift("div", null);
